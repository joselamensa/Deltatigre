const translations = {
    es: {
        ...
        activities: {
            ...
            toursDesc: "Descubre la flora y fauna local con nuestros biólogos especializados.",
            dinner: "Cena en Isla Privada",
            dinnerDesc: "Una experiencia gastronómica única en medio del río.",
            duration: "Duración",
            people: "Hasta 8 personas",
            route: "Ruta personalizada",
            groups: "Grupos pequeños",
            photo: "Fotografía incluida",
            menu: "Menú degustación",
            wine: "Vinos seleccionados",
            music: "Ambiente musical",
            book: "Reservar Ahora"
        },
        testimonials: {
        ...
        contact: {
            ...
            address: "Dique Luján, Tigre, Buenos Aires",
            name: "Tu Nombre",
    ...
    en: {
        ...
        activities: {
            ...
            tours: "Guided Tours",
            toursDesc: "Discover the local flora and fauna with our specialized biologists.",
            dinner: "Private Island Dinner",
    ...
    pt: {
        ...
        activities: {
            ...
            toursDesc: "Descubra a flora e fauna local com nossos biólogos especializados.",
            dinner: "Jantar em Ilha Privada",
            dinnerDesc: "Uma experiência gastronômica única no meio do rio.",
            duration: "Duração",
            people: "Até 8 pessoas",
            route: "Rota personalizada",
            groups: "Pequenos grupos",
            photo: "Fotografia incluída",
            menu: "Menu de degustação",
            wine: "Vinhos selecionados",
            music: "Ambiente musical",
            book: "Reservar Agora"
        },
        testimonials: {
